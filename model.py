...
df = pd.read_csv("application_iris/data/iris.csv")
print(df.head(5))
...
joblib.dump(encoder, "application_iris/saved_models/iris_label_encoder.pkl")
...
joblib.dump(classifier, "application_iris/saved_models/knn_iris_dataset.pkl")
